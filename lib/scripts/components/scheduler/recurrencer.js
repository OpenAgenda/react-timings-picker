    ...
    if ( this.state.createRecurrence == true ) {
      ...
      result = (
        React.createElement("div", null, 
          ...
          React.createElement(DatePicker, {selected: this.state.endDate, onChange: this.onReccurenceEndChange, weekdays: strings.weekdays.short, months: strings.months, dateFormat: this.props.dateFormat, activeDays: activeDays}), 
