...
var Scheduler = React.createClass({displayName: "Scheduler",
  ...
  renderModal: function () {
    ...
    var result = !this.state.showAdjust
      ? null
      : (
        React.createElement(Modal, {ref: "ModalWindow", isOpen: this.state.showAdjust, 
          ...
          React.createElement("div", {className: "rc-time-adjustment"}, 
            ...
            React.createElement("a", {className: "rc-adjust-button", onClick: this.adjustTiming}, "Adjust")
          )
        )
      );
