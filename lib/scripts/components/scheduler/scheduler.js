...
var Scheduler = React.createClass({displayName: "Scheduler",
	...
	render: function () {
		...
		for (var i = 0; i < 7/*7 days in a week*/; i++) {
			...
			days.push(React.createElement(Day, {key: i, dayStartTime: dayStartTime, dayEndTime: dayEndTime, timeCells: times.length, timeStep: step, timings: currentDayTimings, 
		...
		return (
			React.createElement("div", {className: "rc-scheduler"}, 
