  ...
  render: function () {
    ...
    return (
      React.createElement("div", {className: 'rc-day'+extraClassName, onMouseDown: this.onDayMouseDown, onClick: this.props.readOnly ? undefined : this.clickTime}, 
        React.createElement("div", {className: this.props.activeDays.length ? dayNodeClassName + this.getAdditionalClassName() : dayNodeClassName, "data-date": this.props.dayStartTime.toDateString()}, 
