...
var Day = React.createClass({displayName: "Day",
	...
	onDayMouseDown: function (e) {
		...
		event.innerHTML = React.renderToStaticMarkup(
				React.createElement("div", {className: "rc-time"}, 
	...
	render: function () {
		...
		for (var i = 0; i < this.props.timeCells; i++) {
			var newCellMarkup = this.props.readOnly === true ? React.createElement("div", {key: utils.formatTime(date), className: "rc-day-cell"}) :
						React.createElement("div", {key: utils.formatTime(date), className: "rc-day-cell", onClick: this.clickTime.bind(null,date)});
		...
		return (
			React.createElement("div", {className: 'rc-day'+extraClassName, onMouseDown: this.onDayMouseDown}, 
				React.createElement("div", {className: "rc-day-header big"}, weekdays.full), 
				React.createElement("div", {className: "rc-day-header small"}, weekdays.short), 
