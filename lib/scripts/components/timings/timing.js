...
var Timing = React.createClass({displayName: "Timing",
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {className: "rc-event", onMouseDown: this.props.onTimingMouseDown}, 
        ...
        this.props.readOnly ? undefined : React.createElement("div", {className: resizerClassNames, "data-nodrag": "1", onMouseDown: this.props.onResizerMouseDown}), 
        this.props.readOnly ? undefined : React.createElement("div", {className: closeClassNames, "data-nodrag": "1", onClick: this.props.remove.bind(null,this.props.timing)})
      )
    );
  }
});
