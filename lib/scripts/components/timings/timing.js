	...
	render: function () {
		...
		return (
			React.createElement("div", {className: "rc-event", onMouseDown: this.props.onEventMouseDown}, 
				...
				this.props.readOnly ? undefined : React.createElement("div", {className: "rc-event-resizer", onMouseDown: this.props.onResizerMouseDown}), 
				this.props.readOnly ? undefined : React.createElement("div", {className: "rc-event-icon rc-icon rc-icon-close", onClick: this.props.remove.bind(null,this.props.timing)})
			)
			);
	}
});
