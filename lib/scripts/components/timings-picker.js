		...
		return (
			React.createElement("div", {className: "rc-calendar rc-noselect"}, 
				React.createElement("div", {className: "rc-calendar-body"}, 
					...
					React.createElement(Scheduler, {ref: "scheduler", startDate: weekStart, startTime: this.state.startTime, endTime: this.state.endTime, timeStep: this.props.timeStep, 
