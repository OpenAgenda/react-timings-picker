	...
	render: function () {
		...
		if (!this.state.readOnly) {
			...
			if (this.state.isRecurrenceAdded === true) {
				...
				bottompart = React.createElement(Reccurencer, {createRecurrence: this.createRecurrence, startDate: weekStart, endDate: weekEnd, strings: lang, dateFormat: this.props.dateFormat});
			}
		}
