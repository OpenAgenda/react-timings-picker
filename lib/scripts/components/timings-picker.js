	...
	render: function () {
		...
		if (!this.state.readOnly) {
			...
			if (this.state.isRecurrenceAdded === true) {
				...
				bottompart = React.createElement(Reccurencer, {createReccurence: this.createReccurence, startDate: weekStart, endDate: weekEnd, strings: lang, dateFormat: this.props.dateFormat});
			}
	}
		return (
			React.createElement("div", {className: "rc-calendar rc-noselect"}, 
				React.createElement("div", {className: "rc-calendar-body"}, 
					React.createElement(Header, {startDate: weekStart, goAnotherWeek: this.goAnotherWeek, goAnotherMonth: this.goAnotherMonth, goAnotherYear: this.goAnotherYear, 
							months: lang.months.full}), 
					React.createElement(Scheduler, {ref: "scheduler", startDate: weekStart, startTime: this.state.startTime, endTime: this.state.endTime, timeStep: this.props.timeStep, allMinutes: this.state.allMinutes, 
