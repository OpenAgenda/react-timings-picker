...
var Week = React.createClass({
  ...
  renderWeeks: function () {
    ...
    for (var i = 0; i < 7/*days in a week*/; i++) {
      ...
      days.push(React.createElement("span", {key: day.date.toString(), className: this.props.activeDays && this.props.activeDays.length ? className + this.getAdditionalClassName(day.date) : className, onClick: this.props.select.bind(null, day, this.isActiveDay)}, day.number));
