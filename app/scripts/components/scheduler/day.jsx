...
var Day = React.createClass({
  ...
  clickTime: function ( event ) {
    ...
    var y = top + event.clientY - utils.pageOffset( dayNode ).top;
    var timeStep = this.props.timeStep;
    var minutes = (this.props.allMinutes * y) / event.currentTarget.clientHeight;
  ...
  render: function () {
    ...
    for (var i = 0; i < this.props.timeCells; i++) {
      var newCellMarkup = <div key={i.toString() + utils.formatTime(date)} className="rc-day-cell"></div>;
    ...
    for (var i = 0; i < timings.length; i++) {
      ...
      var timeProperties = {
        startMinutesDifference: utils.round(utils.minutesDifference(startDate, timing.start, true, true), timingStep),
        endMinutesDifference: utils.round(utils.minutesDifference(startDate, timing.end, true, true), timingStep),
